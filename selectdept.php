...
<div class = "col-sm-6" style = "background:white;border-radius:2px;box-shadow:2px 2px 5px 10px #e6e6e6;"><br>
                  		<b><h1 style = "font-size:200%;color:black;">Department & Semester</h1></b><br><br>
...
<?php
          ...
          $query_select="select distinct department from book";
          $result=mysql_query($query_select);
	$query_select1="select distinct semester from book";
          $result1=mysql_query($query_select1);
        ?>
           <h4 style="color:black;size:180%;position:absolute;left:100;">Select Department :</h4><br><br>
...
<select name="department">
	...
	<option value="<?php echo $row['department']; ?>"><?php echo $row['department']; ?></option> 
		<?php } ?>	</SELECT>
           ...
           <h4 style="color:black;size:180%;position:absolute;right:26%;top:34%">Select Semester :</h4><br><br>
 <div class="select-style" style="position:absolute;right:5%;top:45%;">
...
<input type = "submit" id = "submit" name = "submit" value = "Fetch Subject" class = "red">
      </form><br><br><br>
