...
<nav class="navbar">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php" style="background:white;color:white;padding-bottom:80px;border-radius:15px;"><img src = "images/bookberries.png" class = "img-responsive" style = "size=200;">
    </div>
...
$insert_query = "insert into student(username,emailid,password,phone,college)values('$username','$emailid','$password','$phone','$college')";
...
<div class = "row text-center">
			<h3 style="color:black"><a href = "selectdept.php" style="color:black;border-style:solid;border-width:4px;padding: 15px;margin: 15px;text-decoration:none;">GET STARTED</a></h3>
      </div>
