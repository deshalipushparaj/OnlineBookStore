...
<div class = "col-sm-6" style = "background:white;border-radius:2px;box-shadow:2px 2px 5px 10px #e6e6e6;"><br>
                  		<b><h1 style = "font-size:200%;color:black;">BOOKS</h1></b>
<b><I><h1 style = "font-size:100%;color:black;">CLICK ON ANY ONE OF THE AVAILABLE BOOKS LISTED BELOW TO DOWNLOAD</h1></I></b>
...
$subject=$_POST['subject'];
        ...
        $result = mysql_query("SELECT book_link,book_name FROM book WHERE department='$department' and semester='$semester' and subject='$subject'") OR DIE(mysql_error());
        ?>
       
           <h4 style="color:black;size:200%;position:center;">
	...
	<?php
             while($row=mysql_fetch_array($result,MYSQL_ASSOC))
              {
           ?>
	<a href="<?php echo $row['book_link'];?>" download><?php echo $row['book_name'];?></a>
<?php } ?>
